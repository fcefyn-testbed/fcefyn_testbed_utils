...
For **logs** when boot fails in multi-node tests (libremesh-tests, `mesh_boot_node`), see [LibreMesh testing approach](https://github.com/libremesh/libremesh-tests/blob/main/docs/libremesh-testing-approach.md#mesh-boot-logs) (libremesh-tests repo).
